...
class Template {
  ...
  static List<Template> allTemplates()
  {
    ...
    list.add(new Template(name: "Fatty", workout: new Workout("Fatty", "PlaceHolder Inst", List<Day>())));
    list.add(new Template(name: "Skinny", workout: new Workout("Skinny", "PlaceHolder Inst", List<Day>())));
